...
const PetCareZone = () => {
  ...
  return (
    <div className='bg-[#1b1a1a] h-screen w-screen m-0 p-0 flex justify-center items-center overflow-hidden'>
      <div className='relative bg-[#FFC832] dark:bg-[#2d2500] w-[90vw] max-w-[50rem] h-[80vh] p-6 overflow-hidden flex flex-col'>
        <div className="flex items-center justify-between">
          <button
            onClick={() => navigate('/additional-info')}
            aria-label="Back to additional info"
            className="bg-[#FFC832] dark:bg-[#FFC832] w-[40px] h-[40px] flex items-center justify-center shadow-[3px_4px_0px_#4b2d8f] active:translate-y-1 active:shadow-[0_2px_0_#4b2d8f] border-none cursor-pointer"
          >
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-2">
          ...
          >
            <img
              ...
              className={`w-[180px] h-[180px] hover:border border-black hover:shadow-[2px_6px_2px_#6b7280] active:translate-y-1 active:shadow-[0_2px_0_#6b7280] ${isStruggling ? 'animate-pulse' : ''}`}
            />
          </button>
        ...
        <div className='flex justify-center gap-[20px] pb-2'>
          <button className="bg-[#64D264] w-[80px] h-[60px] shadow-[2px_6px_2px_#b91c1c] active:translate-y-1 active:shadow-[0_3px_0_#b91c1c]" onClick={() => navigate('/pet-walk')}>WALK</button>
          <button className="bg-[#3296FF] w-[80px] h-[60px] shadow-[2px_6px_2px_#b91c1c] active:translate-y-1 active:shadow-[0_3px_0_#b91c1c]" onClick={() => navigate('/pet-bath')}>BATH</button>
          <button className="bg-[#9664E1] w-[80px] h-[60px] shadow-[2px_6px_2px_#b91c1c] active:translate-y-1 active:shadow-[0_3px_0_#b91c1c]" onClick={() => navigate('/pet-feed')}>FEED</button>
          <button className="bg-[#E13296] w-[80px] h-[60px] shadow-[2px_6px_2px_#b91c1c] active:translate-y-1 active:shadow-[0_3px_0_#b91c1c]" onClick={() => navigate('/pet-play')}>PLAY</button>
        </div>
      </div>
    </div>
  );
