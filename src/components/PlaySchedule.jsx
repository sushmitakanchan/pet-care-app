...
const PlaySchedule = () => {
  ...
  return (
    <div className='bg-[#1b1a1a] min-h-screen w-screen m-0 p-0 flex justify-center items-center'>
      <div className='relative bg-[#E13296] w-[90vw] min-h-[500px] my-4 flex flex-col px-4 py-6 sm:min-h-0 sm:my-0 sm:h-[40rem] sm:w-[50rem] sm:grid sm:grid-cols-2 sm:grid-rows-6 sm:gap-[10px] sm:p-[10px] sm:place-items-center'>
        <button
        ...
        <h3 className='text-center mb-4 mt-20 sm:ml-[25rem] sm:mb-0'>PLAY</h3>
