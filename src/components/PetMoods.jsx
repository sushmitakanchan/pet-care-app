...
const PetMoods = () => {
  ...
  return (
    ...
    <div className='relative bg-[#eaddc3] h-[40rem] w-[50rem] grid grid-cols-2 grid-rows-6 gap-[10px] p-[10px] place-items-center'>
        {/* <h1 className='relative mr-[5rem] text-[20px]'>Mood Journal</h1> */}
        <div className='flex flex-col items-center mt-[20rem]'>
                ...
                <div className='absolute flex mt-[30rem]'>
                <button className="bg-[#64D264] w-[80px] h-[60px] shadow-[2px_6px_2px_#b91c1c] active:translate-y-1 active:shadow-[0_3px_0_#b91c1c] mt-[30px]" onClick={()=>navigate('/pet-walk')}>OK</button>
