...
const BathTracker = () => {
const {dogInfo, walkProgressCounter,walkLabel, bathProgressCounter, setBathProgressCounter, bathLabel, setBathLabel, feedProgressCounter, feedLabel} = useContext(PetContext)
