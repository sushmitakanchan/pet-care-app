...
const ChooseYourPet = () => {
  ...
  return (
    <div className='bg-[#1b1a1a] min-h-screen w-screen m-0 p-0 flex justify-center items-center'>
      <div className='relative bg-[#FF3232] dark:bg-[#2d0808] w-[90vw] max-w-[50rem] min-h-[80vh] my-4 flex flex-col items-center justify-center'>
        <img src={logo} alt="logo" className='w-[100px] h-[80px]' />
        <h1 className='mt-8 text-center dark:text-white'>{pet ? `Your selected pet: ${pet}` : "Choose your pet"}</h1>
